...
describe('Storybook component snapshots', () => {
  const testCases: SnapshotTestCase[] = [
    ...
    },
    {
      ...
      expectedStories: ['Default', 'CustomHandlers', 'MinimalConfig'],
    },
    {
    ...
    },
    {
      ...
      expectedStories: ['WithAddButton', 'WithoutAddButton'],
    },
    {
      name: 'QRCodeDisplay',
    ...
    },
    {
      ...
      expectedStories: ['FirstFailure', 'SecondAttempt', 'MaxRetriesReached'],
    },
    {
      name: 'SecureView',
